 ...
 */
public class AbnormalAssetProcess extends BroadcastProcessFunction<AssetScanOrigin, AssetCdcResult, Tuple3<String, String, AlarmItem>> {
    ...
    private MapStateDescriptor<String, AssetBase> assetBaseMapStateDescriptor = new MapStateDescriptor<>(
    ...
    public AbnormalAssetProcess(int openPortThreshold, String processBlack) {
    ...
    @Override
    public void processElement(AssetScanOrigin asset, ReadOnlyContext ctx, Collector<Tuple3<String, String, AlarmItem>> out) throws Exception {

        OutputTag<AssetScanOrigin> insertTag = new OutputTag<AssetScanOrigin>("insert-tag") {};
        OutputTag<AssetScanOrigin> updateTag = new OutputTag<AssetScanOrigin>("update-tag") {};
    ...
    public void processBroadcastElement(AssetCdcResult value, Context ctx, Collector<Tuple3<String, String, AlarmItem>> out) throws Exception {
        ...
        if(assetBaseBroadcastState != null){
            String afterIp = afterAssetBase.getIp_address();
            String beforeIp = beforeAssetBase.getIp_address();
