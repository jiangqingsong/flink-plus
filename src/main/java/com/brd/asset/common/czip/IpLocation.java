package com.brd.asset.common.czip;
...
public class IpLocation {
    ...
    public static void main(String[] args) throws Exception {
        IpLocation ipLocation = new IpLocation("C:\\Program Files (x86)\\cz88.net\\ip\\qqwry.dat");
        Location location = ipLocation.fetchIPLocation("111111.232.245.73");
        System.out.println(location.country);

        /*System.out.println(ipLocation.fetchIPLocation("221.232.245.73"));
        System.out.println(ipLocation.fetchIPLocation("113.204.226.35"));
        System.out.println(ipLocation.fetchIPLocation("192.168.5.92"));
        System.out.println(ipLocation.fetchIPLocation("202.102.213.68"));
        System.out.println(ipLocation.fetchIPLocation("112.4.0.55"));
        System.out.println(ipLocation.fetchIPLocation("10.0.3.99"));
        System.out.println(ipLocation.fetchIPLocation("134.175.35.162"));
        System.out.println(ipLocation.fetchIPLocation("134.175.35.169"));
        System.out.println(ipLocation.fetchIPLocation("222.182.112.24"));
        System.out.println(ipLocation.fetchIPLocation("117.61.212.188"));
        System.out.println(ipLocation.fetchIPLocation("171.108.233.157"));*/
